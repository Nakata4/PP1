...
<main class="container-fluid px-0 pt-4 m-0 white">
    ...
    <nav class="navbar fixed-top navbar-expand-lg navbar-light bg-light py-0">
        <a class="navbar-brand mr-5" href="index.html"><img src="img/logo.png"/></a>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav mr-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="store.html">Cart</a>
                </li>
                <li class="nav-item">
            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    <div class="about-content">
                        We're the World's leading used car supermarket!
                        We could tell you all about how, as an award-winning retailer, we are the leading car supermarket in the US, that
                        we have thousands of cars in stock, or even how we make sure our cars are the most competitively-priced in the country
                        with our Price Match Promise... but instead, we’ve produced this short video for you to watch.</div>
...
<div class="card-group">
    <div class="card">
        <div class="card-body pl-5">
            ...
            <h6 class=" font-italic"><b>Subscribe to CarStore community!</b></h6>
